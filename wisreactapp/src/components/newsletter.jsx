...
export const Newsletter = () => {
  ...
  const filterNewsletters = () => {
    return data.Newsletters.find((newsletter) => newsletter.mostRecent === true);
  };

  const mostRecentNewsletter = filterNewsletters();

  return (
    <div id="newsletter" className='text-center'>
      <div className="section-title">
        <h2>Interested in our Newsletter?</h2>
        <p>Check out this month's edition, or view past ones{" "}
