...
function PastNewsletters(props) {
  ...
  return (
    <div>
        ...
        <Navigation2 />
        <div className='pastNewsletters-container'>
            <div id='pastNewsletters' className='text-center'>
                <div className='container'>
                    ...
                    <p>
                        Here are our newsletters from this current school year.
                    </p>
                    </div>
                </div>
                <div className="container">
                    {/* Map through each newsletter entry */}
